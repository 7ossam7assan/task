<div class="sidebar">
    <div class="sidebar-inner">
        <div class="sidebar-logo">
            <div class="peers ai-c fxw-nw">
                <div class="peer peer-greed"><a class="sidebar-link td-n" href="#">
                        <div class="peers ai-c fxw-nw">
                            <div class="peer">
                                <div class="logo"><img src="{{asset('Admin/assets/static/images/logo.png')}}" alt=""></div>
                            </div>
        ...
        <ul class="sidebar-menu scrollable pos-r">
            <li class="nav-item mT-30"><a class="sidebar-link" href="/Advertiser/home"><span class="icon-holder"><i
            ...
            <li class="nav-item"><a class="sidebar-link" href="#"><span class="icon-holder"><i
                                class="c-deep-purple-500 ti-comment-alt"></i> </span><span class="title">Profile</span></a></li>


            <li class="nav-item"><a class="sidebar-link" href="/Advertiser/advertises"><span class="icon-holder"><i
                                class="c-deep-purple-500 ti-comment-alt"></i> </span><span class="title">Advertises</span></a></li>
