        ...
        <ul class="nav-right">
            <li class="notifications dropdown"><span class="counter bgc-red">3</span> <a href=""
                ...
                <ul class="dropdown-menu">
                    <li class="pX-20 pY-15 bdB"><i class="ti-bell pR-10"></i> <span class="fsz-sm fw-600 c-grey-900">Notifications</span>
                    </li>
                    <li>
                        <ul class="ovY-a pos-r scrollable lis-n p-0 m-0 fsz-sm">
                            <li><a href="" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                    ...
                                    <div class="peer peer-greed"><span><span class="fw-500">John Doe</span> <span class="c-grey-600">liked your <span
                            ...
                            <li><a href="" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                    ...
                                    <div class="peer peer-greed"><span><span class="fw-500">Moo Doe</span> <span class="c-grey-600">liked your <span
                            ...
                            <li><a href="" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                    ...
                                    <div class="peer peer-greed"><span><span class="fw-500">Lee Doe</span> <span class="c-grey-600">commented on your <span
            ...
            <li class="notifications dropdown"><span class="counter bgc-blue">3</span> <a href=""
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="pX-20 pY-15 ta-c bdT"><span><a href="email.html" class="c-grey-600 cH-blue fsz-sm td-n">View All Email <i
            ...
            <li class="dropdown"><a href="" class="dropdown-toggle no-after peers fxw-nw ai-c lh-1"
                    ...
                    <div class="peer mR-10"><img class="w-2r bdrs-50p" src="{{url(auth()->user()->photo)}}"
                                                 alt=""></div>
                    <div class="peer"><span class="fsz-sm c-grey-900"> @auth {{auth()->user()->name}} @endauth </span></div>
                </a>
                <ul class="dropdown-menu fsz-sm">
                    ...
                    <form  id="profile"
                           style="padding: 14px">
                        <li><a onclick="document.getElementById('profile').submit()"href="#" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700"><i class="ti-user mR-10"></i>
                    ...
                    <form id="logout" method="post" action="{{route('logout')}}" style="padding: 12px">
                        @csrf
                        <li><a  onclick="document.getElementById('logout').submit()" href="#" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700"><i class="ti-power-off mR-10"></i>
                                <span>Logout</span></a>
                        </li>
                    </form>
