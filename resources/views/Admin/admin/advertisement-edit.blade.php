    ...
    <main class='main-content bgc-grey-100'>
        ...
        <div id='mainContent'>
            <form id="doctoreditform" role="form" enctype="multipart/form-data"
                @if(isset($adv)) action="{{route('advertisement.update',$adv->id)}}" @else action="{{route('advertisement.store')}}" @endif  method="post">
                {{csrf_field()}}
                ...
                <button type="submit" class="btn btn-primary" id="submtbtneditadvertise">Submit</button>
            </form>
        </div>
    </main>
